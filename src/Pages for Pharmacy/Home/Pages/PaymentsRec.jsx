...
const filteredPayments = allPayment.filter((payment) => {
  const isNameMatch =
    payment.patientName.toLowerCase().includes(searchKeyword.toLowerCase()) ||
    payment.paymentMethod.toLowerCase().includes(searchKeyword.toLowerCase());
  ...
  if (sortByPaymentMethod === "") {
    ...
    return (
      isNameMatch && payment.paymentMethod.toLowerCase() === sortByPaymentMethod.toLowerCase()
                  ...
                  <MDBTable align="middle" className="mt-4" hover>
                    ...
                    {filteredPayments.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <p className="fw-normal mb-1"> {new Date(item.updatedAt).toLocaleString(
                                  "en-IN"
                                )}</p>
                          </td>
                          <td>

...
import {  updateDoctorAPI, updateReceptionAPI } from '../../../../Services/allAPIs';
import Button from "@mui/material/Button";

function PersonalInfo({recepdet}) {
        ...
        <Container>
                  ...
                  <Row className="mt-4">
                    ...
                    <div className="col-6 mt-4 text-center w-100">
                        <Button  onClick={updateReception} variant="outlined" color="success" className="w-100">
                        Update
                        </Button>
                    </div>
                  </Row>

...
function ViewInvoicewithback({ invoiceData,onBack }) {
 ...
 <div className="d-flex justify-content-between">
      ...
      <Container className="card shadow mt-4" style={{ height: "100vh" }}>
        <div className="d-flex justify-content-between">
          <img src={logo} alt="" className="mt-4" style={{ width: "20%" }} />
          <span className="mt-3 me-2">
           Created Date:{new Date(invoiceData.createdAt).toLocaleString("en-IN")} <br />
           Updated Date:{new Date(invoiceData.updatedAt).toLocaleString("en-IN")}
          </span>
        </div>
        <div>
...
export default ViewInvoicewithback;

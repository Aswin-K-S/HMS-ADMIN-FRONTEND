...
import { viewSingleDoctorAPI } from '../../../Services/allAPIs';
...
const getSingleDoctor = async () => {
  ...
  if (token) {
    ...
    try {
      const result = await viewSingleDoctorAPI(existinguser._id,reqHeader);
      console.log(result);
...
useEffect(()=>{
 getSingleDoctor()
    ...
    const renderContent = () => {
        switch (selectedItem) {
          case 'Information':
            return <PersonalInfo docdet={singleDoctor} />;
          case 'Password':

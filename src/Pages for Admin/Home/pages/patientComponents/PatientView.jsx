    ...
    const renderContent = () => {
        switch (selectedItem) {
          ...
          case 'patientInformation':
            return <PatientInformation patientId={patientId} />;
          case 'healthInformation':
            return <HealthInformation patientId={patientId} />;
          default:
            return null;
        }
      };
                ...
                <div className="card-body">
                    ...
                    <div>
                        <ul id='Patientsli' style={{listStyle:'none'}}>
                            ...
                            <li className={selectedItem === 'invoice' ? 'active' : ''} onClick={() => handleItemClick('invoice')}>

...
const sections = [
  ...
  { id: 4, name: "Receptions", icon: <ManageAccountsOutlinedIcon /> },
  { id: 5, name: "Payments", icon: <LocalAtmOutlinedIcon /> },
  { id: 6, name: "Medicine", icon: <MedicalServicesOutlinedIcon /> },
  { id: 7, name: "Admin", icon: <AdminPanelSettingsOutlinedIcon /> },
        ...
        >
          <Toolbar sx={{display:'flex', justifyContent:'space-between'}}>
            ...
            <Tooltip title="Open settings">
              ...
              <Avatar alt={existinguser.username}  src={existinguser.profile ? `${baseUrl}/uploads/${existinguser.profile}` : img} /> &nbsp;&nbsp;&nbsp; <span style={{fontSize:'15px'}}>{existinguser.username}</span>
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
